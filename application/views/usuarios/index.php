			...
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						...
						<div class="card-body">
							<a href="<?php echo base_url($this->router->fetch_class() . '/core'); ?>"
							   class="btn btn-primary"><i class="ik ik-plus"></i> Novo Usuário</a>
						</div>
						<div class="card-body">
							<table class="table data_table">
								...
								<?php foreach ($usuarios as $usuario): ?>
									<tr>
										...
										<td>
											<?php echo($usuario->active == 1 ? '<span class="badge badge-success"><i class="fas fa-lock-open"></i> Sim</span>' : '<span class="badge badge-danger"><i class="fas fa-lock"></i> Não</span>'); ?>
										</td>
										<td>
											<a data-toggle="tooltip" data-placement="bottom"
											   title="Editar <?php echo $this->router->fetch_class(); ?>"
											   href="<?php echo base_url('usuarios/core/' . $usuario->id); ?>"
											   class="text-primary" style="font-size: 1.2em;"><i class="ik ik-edit"></i></a>
											<a data-toggle="modal" data-target="#user-<?php echo $usuario->id; ?>"
											   data-placement="top"
											   title="Excluir <?php echo $this->router->fetch_class(); ?>"
											   href="javascript:void(0);" class="text-danger delete"
											   data-id="<?php echo $usuario->id; ?>" style="font-size: 1.2em;"><i
													class="ik ik-trash-2"></i></a>
										</td>
									</tr>

									<div class="modal fade" id="user-<?php echo $usuario->id; ?>" tabindex="-1" role="dialog"
										 aria-labelledby="exampleModalCenterLabel" aria-hidden="true">
										<div class="modal-dialog modal-dialog-centered" role="document">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="exampleModalCenterLabel">Deseja excluir o usuário <?php echo $usuario->first_name." ".$usuario->last_name; ?>?</h5>
												...
												<div class="modal-footer">
													...
													<a  href="<?php echo base_url('usuarios/del/' . $usuario->id); ?>" type="button" class="btn btn-danger">Excluir</a>
												</div>
											</div>
										</div>
									</div>
